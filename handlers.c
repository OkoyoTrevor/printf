...
/************************* WRITE HANDLE *************************/
/**
 * my_handle_write_char - Prints a string
 * @c: char types.
...
/************************* WRITE NUMBER *************************/
/**
 * to_write_num - Prints a string
 * @is_negative: List of arguments in a function
 * @ind: character types.
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
 ...
 * Return: Number of characters printed.
 */
int to_write_num(int is_negative, int ind, char buffer[],
	int flags, int width, int precision, int size)
{
...
/**
 * my_write_num - Write a number using a bufffer
 ...
 */
int my_write_num(int ind, char buffer[],
...
/**
 * to_write_unsgnd - Writes an unsigned number
